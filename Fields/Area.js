...
window.XOAreaElement = class extends XOElement {
    ...
    static get methods() {
        return {
            ...
            inputHandler() {
                this.$.text.css("height", "0");
                this.$.text.css("height", this.$.text.scrollHeight + "px");
            },
            focusHandler() {
...
XOAreaElement.prototype.tag = "xo-area";

customElements.define(XOAreaElement.prototype.tag, XOAreaElement);