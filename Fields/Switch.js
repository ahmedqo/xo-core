...
window.XOSwitchElement = class extends XOElement {
    ...
    render() {
        return /*html*/ `
            <main id="xo-container" (click|prev)="{{>clickHandler()}}">
...
XOSwitchElement.prototype.tag = "xo-switch";

customElements.define(XOSwitchElement.prototype.tag, XOSwitchElement);