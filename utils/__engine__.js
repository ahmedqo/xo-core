...
//             code = type ? `r.push("("+${fun}.toString().replaceAll("\\"","\'")+")("+${props}+")");` : `r.push((${fun})(${props}));`;
//         } else {
...
var { _typeof, _slicedToArray, _toConsumableArray } = require("./__runtime__");
...
function addVariable(line, js) {
    ...
    if (js) {
        ...
        if (line.startsWith(">")) {
            ...
            var _fill = __fill(line);

            var _fill2 = _slicedToArray(_fill, 2);
